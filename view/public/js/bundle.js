...
exports.updateUser = exports.updatePassword = exports.signup = exports.login = void 0;
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, password) {
    var res, divError;
...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(pseudo, email, password, confirmPassword) {
    var res, divError;
...
var updateUser = /*#__PURE__*/function () {
  ...
  return function updateUser(_x7) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "GET",
            url: "http://127.0.0.1:3000/api/quiz/".concat(category, "/start")
          });
        case 3:
          res = _context.sent;
        ...
        case 11:
          _context.prev = 11;
          _context.t0 = _context["catch"](0);
          document.getElementById("game__error").innerHTML = "Error : ".concat(_context.t0.response.data.message);
        case 14:
        case "end":
          return _context.stop();
      }
...
var format = function format(quiz, numQuestion, nbQuestions, first) {
  var question = quiz.question,
    category = quiz.category,
    _id = quiz._id,
    choices = quiz.choices;
  var divgGame = document.getElementById("game");
  var divBtn = document.getElementById("game__btn");
  ...
  divGameInfo.innerHTML = "\n  <div class=\"game__numQuestion\">Question : ".concat(numQuestion, " / ").concat(nbQuestions, "</div>\n          <div class=\"game__question\">").concat(question, "</div>\n          <div class=\"game__choices\">\n            <div class=\"game__radio\" id=\"radio\">\n              <input type=\"radio\" id=\"choice\" name=\"choice\" value=\"").concat(choices[0], "\"/>\n              <label for=\"choice\">").concat(choices[0], "</label>\n            </div>\n            <div class=\"game__radio\" id=\"radio1\">\n              <input type=\"radio\" id=\"choice1\" name=\"choice\" value=\"").concat(choices[1], "\" />\n              <label for=\"choice1\">").concat(choices[1], "</label>\n            </div>\n            <div class=\"game__radio\" id=\"radio2\">\n              <input type=\"radio\" id=\"choice2\" name=\"choice\" value=\"").concat(choices[2], "\" />\n              <label for=\"choice2\">").concat(choices[2], "</label>\n            </div>\n            <div class=\"game__radio\" id=\"radio3\">\n              <input type=\"radio\" id=\"choice3\" name=\"choice\" value=\"").concat(choices[3], "\" />\n              <label for=\"choice3\">").concat(choices[3], "</label>\n            </div>\n          </div>\n  ");
  divgGame.appendChild(divGameInfo);
  var radioChoices = document.getElementsByName("choice");
  radioChoices.forEach(function (el) {
...
var check = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(choices, el, id, category, numQuestion, nbQuestions) {
    var answer, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://127.0.0.1:3000/api/quiz/".concat(category, "/").concat(id),
            data: {
              answer: answer
            }
          });
        ...
        case 8:
          ...
          document.getElementById("game__error").innerHTML = "Error : ".concat(_context2.t0.response.data.message);
        case 11:
        case "end":
          return _context2.stop();
      }
  ...
  return function check(_x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
var showResult = function showResult(data) {
  var divgGame = document.getElementById("game");
  var gameInfo = document.getElementById("game__info");
  divgGame.removeChild(gameInfo);
  var dataSuccess = "fail";
  var statSuccess = Math.round(data.score / data.nbQuestions * 100);
  var statFail = Math.round((data.nbQuestions - data.score) / data.nbQuestions * 100);
  var result = "Raté";
  if (data.score >= data.nbQuestions / 2) {
    dataSuccess = "success";
    result = "Réussi";
  }
  var divGameEnd = document.createElement("div");
  divGameEnd.classList.add("game__end");
  divGameEnd.id = "game__end";
  divGameEnd.innerHTML = "<div class=\"game__success game__success--".concat(dataSuccess, "\">\n          <p>").concat(result, "</p>\n      </div>\n      <div class=\"game__score game__score--").concat(dataSuccess, "\">\n          <p>").concat(statSuccess, "%</p>\n      </div>\n      <div class=\"game__infoQuiz\">\n          <p>Reussi : ").concat(statSuccess, "%</p>\n          <p>Rat\xE9 : ").concat(statFail, "% </p>\n      </div>");
  divgGame.appendChild(divGameEnd);
};
var showNextQuestion = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(url, numQuestion, nbQuestions) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
  ...
  return function showNextQuestion(_x8, _x9, _x10) {
    return _ref3.apply(this, arguments);
  };
}();
var showResponse = function showResponse(choices, el, data) {
...
},{"axios":"../../../node_modules/axios/index.js"}],"menu.js":[function(require,module,exports) {
"use strict";
...
var menuSection = document.getElementById("menu__section");
...
if (btnInscription) {
  btnInscription.addEventListener("click", function (e) {
    ...
    (0, _login.signup)(pseudo, email, password, confirmPassword);
  });
}
if (btnUpdate) {
